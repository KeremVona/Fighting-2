...
import StrategyCard from "../../phases/phase2/StrategyCard";
...
const HandleNavigation = () => {
  ...
  const totalPages = Math.ceil(fighterStrategies.length / ITEMS_PER_PAGE);
  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const chosenStrategies = fighterStrategies.slice(
    startIndex,
